    ...
    def render_login(self):
        ...
        with st.container(horizontal_alignment="center"):
            with st.form("login_form", width="content"):
                ...
                st.caption("Admin Log-in process. NOTE: The password must be at least 8 characters long, and include at least one uppercase letter and one symbol.")
    ...
    def render_registration(self):
        ...
        with st.container(horizontal_alignment="center"):
            with st.form("registration_form", width="content"):
                st.title("SUPER Admin Registration")
